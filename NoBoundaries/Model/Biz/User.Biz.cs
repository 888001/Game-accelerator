...
namespace NoBoundaries.Model
{
    ...
    public partial class User : Entity<User>
    {
        ...
        public static User FindBySerialCode(String serialcode)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static IList<User> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
