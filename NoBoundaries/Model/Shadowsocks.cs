...
namespace NoBoundaries.Model
{
    ...
    [BindTable("Shadowsocks", Description = "", ConnName = "NoBoundaries", DbType = DatabaseType.SqlServer)]
    public partial class Shadowsocks : IShadowsocks
    {
        #region 属性
        ...
        #region 字段名
        /// <summary>取得Shadowsocks字段信息的快捷方式</summary>
        ...
        /// <summary>取得Shadowsocks字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>Shadowsocks接口</summary>
    /// <remarks></remarks>
    public partial interface IShadowsocks
    {
        #region 属性
        /// <summary></summary>
